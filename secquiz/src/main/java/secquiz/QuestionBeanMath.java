...
public class QuestionBeanMath {
	private Integer id_question,id_question_selon_livre,typeQuest;
	private String question, sousQuestion1, sousQuestion2, a, b, c, d, reponse,explication, sujets_traites;
	
	public QuestionBeanMath() {
		super();
	...
	public int hashCode() {
		...
		result = prime * result + ((id_question_selon_livre == null) ? 0 : id_question_selon_livre.hashCode());	
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QuestionBeanMath other = (QuestionBeanMath) obj;
		if (a == null) {
			if (other.a != null)
				return false;
		...
		if (id_question == null) {
			...
			return false;		
		if (id_question_selon_livre == null) {
			if (other.id_question_selon_livre != null)
				return false;
		} else if (!id_question_selon_livre.equals(other.id_question_selon_livre))
			return false;		
		if (question == null) {
	...
	public String toString() {
		return "QuestionBeanMath [id_question=" + id_question + ", id_question_selon_livre=" + id_question_selon_livre 
				+ ", typeQuest=" + typeQuest + ", question=" + question + ", sousQuestion1=" + sousQuestion1
				+ ", sousQuestion2=" + sousQuestion2 + ", a=" + a + ", b=" + b + ", c=" + c + ", d=" + d + ", reponse="
				+ reponse + ", explication=" + explication + ", sujets_traites=" + sujets_traites + "]";
	}

	public Integer getId_question_selon_livre() {
		return id_question_selon_livre;
	}

	public void setId_question_selon_livre(Integer id_question_selon_livre) {
		this.id_question_selon_livre = id_question_selon_livre;
	} 
